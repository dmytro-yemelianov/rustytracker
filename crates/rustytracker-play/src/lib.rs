...
pub use channel::{
    ChannelSampleFrame, PlaybackChannelState, PlaybackEnvelopeState, PlaybackSampleValue,
    ...
    EFFECT_VOLUME, EFFECT_VOLUME_SLIDE, PLAYBACK_EMPTY_VOLUME, PLAYBACK_INSTRUMENT_NUMBER_BASE,
