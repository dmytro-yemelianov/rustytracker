...
pub use effects::{
    ...
    EFFECT_FINE_VOLUME_SLIDE_UP, EFFECT_GLOBAL_VOLUME, EFFECT_GLOBAL_VOLUME_SLIDE, EFFECT_NOTE_CUT,
    EFFECT_PANNING, EFFECT_PANNING_SLIDE, EFFECT_PORTAMENTO_DOWN, EFFECT_PORTAMENTO_UP,
    EFFECT_SAMPLE_OFFSET, EFFECT_TONE_PORTAMENTO, EFFECT_TREMOLO, EFFECT_TREMOLO_CONTROL,
    EFFECT_TREMOR, EFFECT_VIBRATO, EFFECT_VIBRATO_CONTROL, EFFECT_VIBRATO_VOLSLIDE, EFFECT_VOLUME,
    EFFECT_VOLUME_SLIDE, VIB_TAB,
};
