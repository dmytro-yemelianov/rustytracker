...
use rustytracker_core::{
    ...
    EDITOR_PATTERN_CHANNELS, INTERNAL_EFFECT_EXTENDED_BASE, INTERNAL_EFFECT_EXTENDED_MAX,
    INTERNAL_EFFECT_EXTRA_FINE_PORTA_BASE, INTERNAL_EFFECT_EXTRA_FINE_PORTA_MAX,
    INTERNAL_EFFECT_EXTRA_FINE_PORTA_MIN, INTERNAL_EFFECT_NONZERO_ARPEGGIO, MAX_ACTIVE_ORDERS,
    MAX_INSTRUMENTS, MAX_PATTERNS, MIN_ACTIVE_ORDERS, MIN_CHANNEL_COUNT, SAMPLES_PER_INSTRUMENT,
    SAMPLE_DEFAULT_FLAGS, SAMPLE_DEFAULT_VOLUME_FADEOUT, XM_EFFECT_EXTENDED,
};
