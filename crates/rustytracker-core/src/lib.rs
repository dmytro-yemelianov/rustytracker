...
pub const EFFECT_NIBBLE_MASK: u8 = 0x0f;
pub const XM_EFFECT_EXTENDED: u8 = 0x0e;
pub const INTERNAL_EFFECT_NONZERO_ARPEGGIO: u8 = 0x20;
pub const INTERNAL_EFFECT_EXTENDED_BASE: u8 = 0x30;
pub const INTERNAL_EFFECT_EXTENDED_MAX: u8 = INTERNAL_EFFECT_EXTENDED_BASE + EFFECT_NIBBLE_MASK;
pub const INTERNAL_EFFECT_EXTRA_FINE_PORTA_BASE: u8 = 0x40;
pub const XM_EXTRA_FINE_PORTA_UP_COMMAND: u8 = 0x01;
pub const XM_EXTRA_FINE_PORTA_DOWN_COMMAND: u8 = 0x02;
pub const INTERNAL_EFFECT_EXTRA_FINE_PORTA_MIN: u8 =
    INTERNAL_EFFECT_EXTRA_FINE_PORTA_BASE + XM_EXTRA_FINE_PORTA_UP_COMMAND;
pub const INTERNAL_EFFECT_EXTRA_FINE_PORTA_MAX: u8 =
